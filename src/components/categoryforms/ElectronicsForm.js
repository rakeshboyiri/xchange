...
const ElectronicsForm = ({ categoryDetails, setCategoryDetails }) => {
  ...
  return (
    <form
      onSubmit={handleNext}
      className="w-full max-w-lg mx-auto ml-0 p-6 bg-white shadow-md rounded-lg"
    >
      <div className="mb-4">
      ...
      <div className="mb-4">
        <label className="block font-semibold text-sm mb-1" htmlFor="photos">
          Upload Photo *
        </label>
        <input
          type="file"
          ...
          required
        />
        <small>Make sure size of each image is less than 1MB</small>
      </div>
    </form>
  );
};
